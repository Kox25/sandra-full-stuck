...
const EditArticleForm = () => {
    ...
    const contentSave=async (event) => {
        ...
        try{
            const response=await axiosClient.post(`Articles/update/content/${id}`,formData);
        ...
        <div className="editArticleContent">
            <div className="contentPart">
                ...
                <div >
                    ...
                    <textarea type="text" className="content" onChange={handleContentChange} value={content}/>
